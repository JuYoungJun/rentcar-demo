...
INSERT IGNORE INTO `settings` (`key`, `value`) VALUES
  ('site',     '{"topBannerText":"월렌트 전문 해태렌트카","contactPhone":"0000-0000","contactHours":"평일 09:00~18:00\\n주말 10:00~16:00","branchName":"해태렌트카 광주지점","branchHours":"평일 09:00 - 18:00 / 주말 10:00 - 16:00","footerDesc":"안전과 투명한 운영을 최우선으로\\n믿고 맡길 수 있는 렌트카 서비스","footerCopyright":"© 2026 해태렌트카. All rights reserved.","defaultDetailBanner":"detail-page.webp"}'),
  ('business', '{"companyName":"해태렌트카","ceoName":"홍길동","bizRegNumber":"000-00-00000","onlineSalesNumber":"제2026-광주광산-0000호","industry":"서비스업 / 자동차 임대업","address":"광주광역시 광산구","contactEmail":"contact@haetae-rentcar.example","privacyOfficerName":"해태렌트카 개인정보 보호책임자","privacyEmail":"privacy@haetae-rentcar.example","privacyPhone":""}'),
  ('about',    '{"heading":"렌트의 새로운 기준","subheading":"합리적인 요금과 다양한 차량 라인업","description":"","stat1Label":"누적 고객 수","stat1Value":15000,"stat2Label":"보유 차량","stat2Value":500,"stat3Label":"고객 만족도 (%)","stat3Value":98,"stat4Label":"전국 지점","stat4Value":8}'),
