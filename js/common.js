...
(function() {
  ...
  const DEFAULT_FAQ = [
    { q: '견적 신청 후 답변까지 얼마나 걸리나요?',
      a: '영업시간(평일 09:00~18:00) 내 신청 시 평균 1시간 이내에 전담 상담사가 연락드립니다. 영업시간 외 접수 건은 다음 영업일에 순차적으로 안내해드립니다.' },
  ...
  const DEFAULT_INFO = {
    ...
    sections: [
      { title: '1. 상담 및 견적', body: '홈페이지 견적 문의 양식 또는 전화로 상담을 요청하시면, 전담 상담사가 차종·기간·예산을 함께 검토하여 맞춤 견적을 안내해 드립니다. 영업시간은 평일 09:00 ~ 18:00 입니다.' },
