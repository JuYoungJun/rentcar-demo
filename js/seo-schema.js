...
(function () {
  ...
  const PLACEHOLDER = {
    ...
    keywordsBlob:    '광주 렌트카, 광주 렌터카, 광주광역시 렌트카, 광산구 렌트카, 광산구 렌터카, 신창동 렌트카, 해태렌트카, 광주 월렌트, 광주 장기렌트, 광주 중고차 장기렌트, 경차 월렌트, 월렌트, 장기렌트, 12개월 기간약정, 중고차 장기렌트, 무심사 렌트카, 무보증 렌트카, 저신용 렌트카, 사회초년생 렌트카, 직장인 월렌트, 법인 렌트카, 모닝 월렌트, 레이 월렌트, 캐스퍼 월렌트, 아반떼 월렌트, K5 월렌트, 소나타 월렌트, 셀토스 월렌트, 카니발 장기렌트, 쏘렌토 장기렌트, 그랜져 장기렌트'
  };
